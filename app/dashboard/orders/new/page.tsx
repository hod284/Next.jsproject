...
export default function NewOrderPage () {
    ...
    const handlesubmit =async(e:React.FormEvent) =>{
        ...
        {
            console.log('주문추가 실패');
            setError(error instanceof Error ? error.message:"주문 추가 실패");
        }
        finally
        {
           setsubmit(false);   
  ...
  return (
        <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-6">
                ...
                <h1 className="text-3xl font-bold text-gray-900">주문 추가</h1>
                <p className="text-gray-600 mt-2">새로운 주문을 추가합니다</p>
            </div>
                ...
                <form onSubmit={handlesubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                        />
                        <p className="text-xs text-gray-500 mt-1">고유한 주문번호를 입력하세요</p>
                    </div>
